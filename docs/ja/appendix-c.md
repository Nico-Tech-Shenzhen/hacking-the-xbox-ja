...
> [!NOTE]
> 高性能・低ノイズアプリケーションでは、デカップリングコンデンサと電源ピンの間にビアを置くことが、ルーティングの利便性に対して電源インテグリティのコストとして高すぎる場合がある。ビアは高速（数百 MHz）の信号の伝搬を乱す。したがって、このようなアプリケーションにおけるデカップリングコンデンサの最適な配置は、部品のピンと電源ビアの間だ。
