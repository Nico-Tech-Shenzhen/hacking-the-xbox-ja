...
この方法は、『Hacking the Xbox』で最初に思いついたものではない。先月、ニコ技深圳で翻訳した[『2025 China Open Source Report』日本語訳](https://github.com/Nico-Tech-Shenzhen/2025-China-Open-Source-Report)で試したものだ。中国語の報告書を、翻訳ガイドと用語集を更新しながら訳し、気になった表現を次の章へ持ち越す。事実や動向を正確に伝えるレポートでは、このやり方はかなりうまく機能した。
...
今回の翻訳は、AIに本を丸ごと渡して、日本語にしてもらったわけではない。AIが作った翻訳を読み、どこが間違っているかだけでなく、どこが面白くなくなっているかを考え、その理由を翻訳の仕様へ戻し、ほかの部分もupdateする仕組みを作っている。
