...
AIについて、「これからは人間が詳しくなくても、AIに聞けばなんとかなる」「知識を覚えたり、自分で考えたりする必要がなくなる」という話をよく見る。これまで教育や学習にたいして関心があるようには見えなかった人が、AIが出てきた途端に「もう勉強しなくていい」「AIに作らせればいいじゃん」と言い出すことも多い。

僕はこの考え方が嫌いだし、単に態度として好きではないというだけでなく、間違っていると思っている。

もちろん、AIによって、これまで専門家にしかできなかったことを多くの人が始められるようになるのはよいことだ。英語が得意でなくても海外の情報を読めるし、プログラミングを始めたばかりの人でも動くコードを作れる。文章を書くことに慣れていない人でも、最初のたたき台を作れる。僕自身、この翻訳でAIの能力をかなり使っている。
...
たとえば[第8章](/ja/ch08)では、僕が読んで気になった部分をもとに、ChatGPTに章全体から同じ傾向の問題を抽出させた。その結果を個別の修正一覧で終わらせず、今後の章にも使える翻訳ルールに変換し、翻訳ガイドを更新する指示を作った。その新しいガイドを使って、第8章全体をClaude Codeで再翻訳している。
...
1. 原文、翻訳ガイド、用語集を使ってAIが翻訳する。
2. 僕が章全体を読み、誤訳、技術的な問題、日本語の違和感を見つける。
3. ChatGPTを使い、同じ種類の問題が章内やほかの章にもないかを調べる。
4. 個別の修正を一般化し、翻訳ガイドや用語集を更新する。
5. Claude Codeが新しい仕様を使って章全体を再翻訳し、サイトをビルドする。
6. GitHub Pagesで公開し、読者からの指摘も次の仕様変更に使う。

ChatGPTには主にレビューと問題の一般化をさせ、Claude Codeにはリポジトリにあるファイルを読み、実際の翻訳、修正、ビルドをさせている。GitHubには翻訳結果だけでなく、翻訳ルールと、そのルールを変更した履歴も残る。

文章を一つずつ直すのではなく、次に作る文章がよくなる仕組みを直している。入力があり、仕様があり、実装があり、レビューがあり、問題が見つかれば仕様へ戻るので、やっていることはエンジニアリングそのものだと思う。
...
しかも、最初から完全な仕様を作ることはできない。今回も翻訳を始める前にガイドを作り、その時点ではかなり考えたつもりだった。でも、実際に生成された文章を読むと、想定していなかった問題がいくらでも出てくる。成果物を作り、レビューし、その結果をもとに仕様を更新するしかない。
...
翻訳なら、その本が好きな人が必要だ。ソフトウェアなら、そのソフトウェアが解決しようとしている問題を気にしている人、製品なら、その製品を使う人や、それによって起きる変化に興味がある人が必要になる。対象に興味がない人でも、仕様に合っているかは確認できるかもしれない。でも、面白いか、つまらないか、大事なものを失っていないかを判断するのは難しい。
